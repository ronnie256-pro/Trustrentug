...
urlpatterns = [
    ...
    path('admin-dashboard/property/add-house/', views.admin_add_house_property, name='admin_add_house_property'),
    path('admin-dashboard/category/add/', views.admin_add_property_category, name='admin_add_property_category'),
    path('admin-dashboard/category/delete/<int:category_id>/', views.admin_delete_property_category, name='admin_delete_property_category'),
    path('admin-dashboard/category/toggle/<int:category_id>/', views.admin_toggle_property_category, name='admin_toggle_property_category'),
